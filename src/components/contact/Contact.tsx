...
const Contact: FC<IContactProps> = ({}) => {
  return (
     <div className={"w-full h-[300px]  min-w-[200px] rounded text-blue-50 bg-logo bg-no-repeat bg-cover"}>
       <div className={'w-full h-full px-10 rounded flex justify-start items-center bg-gray-800 bg-opacity-70'}>
         ...
         <div className="profile_info flex-1 px-3">
           ...
           <p className={'opacity-80'}>Frontend Developer</p>
         </div>
         <ul className={`${style.profile_social_links}`}>
           <li>
             <img src={phone} alt=""/>
             <p>89228086068</p>
           </li>
